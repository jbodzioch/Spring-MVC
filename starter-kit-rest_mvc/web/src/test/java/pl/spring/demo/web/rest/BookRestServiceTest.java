...
public class BookRestServiceTest {
	...
	@Test
	public void testShouldCallDeleteBookInService() throws Exception {
		// given
		final long id = 2L;

		final BookTo bookTo = new BookTo(id, "title", "authors");
		File file = FileUtils.getFileFromClasspath("classpath:pl/spring/demo/web/json/bookToSave.json");
		String json = FileUtils.readFileToString(file);

		Mockito.when(bookService.deleteBook(id)).thenReturn(bookTo);

		// when
		ResultActions response = this.mockMvc.perform(delete("/delete").accept(MediaType.APPLICATION_JSON)
	...
	@Test
	public void testShouldCallPutBookInService() throws Exception {
		// given
		final long id = 2L;
		...
		// when
		ResultActions response = this.mockMvc.perform(put("/put").accept(MediaType.APPLICATION_JSON)
				.contentType(MediaType.APPLICATION_JSON).content(json.getBytes()));
		// then
	...
	@Test
	public void testShouldCallSaveBookInService() throws Exception {
		// given
		final long id = 2L;
